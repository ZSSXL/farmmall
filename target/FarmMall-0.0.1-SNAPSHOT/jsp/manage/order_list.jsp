            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body ">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                <a title="详情"  onclick="xadmin.open('详情','${pageContext.request.contextPath}/manage/queryByUserId.do?id=${order.userId}&orderNo=${order.orderNo}',800,500)" href="javascript:;">
                ...
                <div class="layui-card-body ">
                    <div class="page">
                        <div>
                            <a class="prev"
                               href="${pageContext.request.contextPath}/manage/queryAllOrders.do?page=1&size=${pageInfo.pageSize}">&lt;&lt;</a>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <a class="num active"
                                   href="${pageContext.request.contextPath}/manage/queryAllOrders.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>

                            </c:forEach>
                            <a class="next"
                               href="${pageContext.request.contextPath}/manage/queryAllOrders.do?page=${pageInfo.total}&size=${pageInfo.pageSize}">&gt;&gt;</a>
                        </div>
                    </div>
                </div>
            </div>
...
function member_del(obj, id) {
    layer.confirm('确认要删除吗？',
        function(index) {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/manage/deleteOrderById.do",
                data: {
                    "id": id,
                },
                success: function () {
