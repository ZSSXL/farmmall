...
<div class="box">
        <div class="row">
                ...
                <div class="col-md-5">
                        ...
                        <div style="padding-top: 20px;">
                                ...
                                <button id="add_cart_btn" class="btn btn-danger" style="margin-left: 80px;margin-top30px;width: 200px;">
                                        <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;加入购物车
                                </button>
                                <button id="add_collection_btn" class="btn btn-success" style="margin-left: 80px;margin-top:20px;width: 200px;">
        ...
        <div class="relation">
                <div class="col-md-6">
                        <h4>牲畜品种：<input id="vatrieties" type="text" placeholder="暂无数据" disabled></h4>
                        <h4>身体状况：<input id="health" type="text" placeholder="暂无数据" disabled></h4>
                        <h4>年龄：<input id="age" type="text" placeholder="暂无数据" disabled></h4>
                        <h4>主食：<input id="stapleFood" type="text" placeholder="暂无数据" disabled></h4>
                        <h4>病历：<input id="medicalRecord" type="text" placeholder="暂无数据" disabled></h4>

                </div>
                <div class="col-md-6">
                        <h4>生产地：<input id="origin" type="text" placeholder="暂无数据" disabled></h4>
                        <h4>粪便：<input id="faces" type="text" placeholder="暂无数据" disabled></h4>
                        <h4>疫苗：<input id="vaccine" type="text" placeholder="暂无数据" disabled></h4>
                        <h4>照片：<img id="photo" src="${APP_PATH}/static/images/other/piky.jpg" style="width: 40px;height: 40px;" align="照片"></h4>
