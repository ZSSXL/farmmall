...
<div class="box">
        <div class="col-md-2 aside">
                ...
                <div class="row" style="padding-left: 10px;padding-top: 20px;">
                        ...
                        <div style="padding-left: 28px;padding-top: 10px;"><a href="${APP_PATH}/jsp/selledbaby.jsp" style="color: rgba(247,91,93,1.00);">订单查询</a></div>
                </div>
                <div class="row" style="padding-left: 10px;padding-top: 20px;">
        ...
        <div class="col-md-10 middle">
                <div class="row">
                        <div class="seller">我是卖家&nbsp;&gt;&nbsp;交易管理&nbsp;&gt;&nbsp;订单查询</div>
                </div>
                <hr size="1px">
                <div class="row">
                        <ul class="nav nav-pills">
                                <li>
                                        <a href="#" id="all_order">全部订单</a>
                                </li>
                                <li>
                                        <a href="#" id="unpay">等待买家付款</a>
                                </li>
                                <li>
                                        <a href="#" id="payed">等待发货</a>
                                </li>
                                <li>
                                        <a href="#" id="sended">已发货</a>
                                </li>
                                <li>
                                        <a href="#" id="end_order">成功的订单</a>
                                </li>
                        </ul>
                </div>
                <div class="row">
...
<script type="text/javascript">
    ...
    $(document).on("click",".to-send",function () {
       window.location.href = "${APP_PATH}/jsp/send.jsp";
    });
    ...
    $(document).on("click", ".show_product_detail", function () {
        ...
        $(document).on("click",".btn-danger",function () {
            // alert($(this).attr("order_no"));
            var orderNo = $(this).attr("order_no");
            $.ajax({
                url:"${APP_PATH}/order/delete_by_seller.do",
                type:"post",
        ...
        function analysisInfo(result) {
            ...
            $.each(orderList,function (index,orderItem) {
               ...
               var toSendBtn = $("<button class='btn btn-info to-send' style='margin-left:5px'>去发货</button>")
                var statusTd = $("<td></td>");

                if(orderItem.status == 10){
                    statusTd.append("等待付款");
